...
.config ['$routeProvider', '$locationProvider', ($routeProvider) ->
  ...
  .run ['$rootScope', '$location', '$route', '$anchorScroll', '$cookieStore', ($rootScope, $location, $route, $anchorScroll, $cookieStore) ->
      ...
      $rootScope.shareInfos.title = 'My title'
      $rootScope.shareInfos.urlfb = 'http://example.com/'
      $rootScope.shareInfos.urltwitter = encodeURIComponent('http://example.com/')
      $rootScope.shareInfos.urlkakao = 'http://example.com/'
      $rootScope.shareInfos.urlkstory = 'http://example.com/'
      $rootScope.shareInfos.img = 'http://example.com/images/share.jpg'
      $rootScope.shareInfos.twitter = encodeURIComponent('My twitter message')
      $rootScope.shareInfos.kakao = 'My description'
      $rootScope.shareInfos.kstory = {}
      $rootScope.shareInfos.kstory.post = 'My description' + $rootScope.shareInfos.urlkstory
      $rootScope.shareInfos.kstory.appname = 'My title'
